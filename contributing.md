...
## Code of Conduct
All contributors to this project must adhere to the [Community Code of Conduct](https://github.com/Invoca/nmap-diff/blob/master/code-of-conduct.md)

## Environment Setup
1. Install the correct version of GoLang. This project uses 1.14
2. Make a fork of Tenable-Scan-Launcher, then clone your fork to your machine
3. Run `go get` in your Tenable-Scan-Launcher directory to install dependencies.
...
* Resolve linting comments before requesting review
